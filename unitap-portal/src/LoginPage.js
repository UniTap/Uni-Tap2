...
//this function shows the front page of the login card where we input our info
function LoginPage() {
    ...
    $("#do_login").click(function () {
      ...
      $("#login_form input").each(function () {
        if (!$.trim($(this).val())) {
          ...
          //if warning is displayed then don't proceed
          proceed = false;
        }
      });
  ...
  //used to open more info page(...) which shows forgot password and contact support
  ...
  //used for closing the more info page(...) to return to the original front page
...
// here like any programming language we call the functions declared 
  return (
